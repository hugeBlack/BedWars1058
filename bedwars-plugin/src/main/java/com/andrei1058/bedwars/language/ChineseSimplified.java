...
public class ChineseSimplified extends Language {
    public ChineseSimplified() {
        ...
        yml.addDefault(Messages.COMMAND_MAIN, Arrays.asList("", "&2▪ &7/" + BedWars.mainCmd + " stats", "&2▪ &7/" + BedWars.mainCmd + " join &o<游戏/模式组>", "&2▪ &7/" + BedWars.mainCmd + " leave", "&2▪ &7/" + BedWars.mainCmd + " lang", "&2▪ &7/" + BedWars.mainCmd + " gui", "&2▪ &7/" + BedWars.mainCmd + " start &3(vip)"));
        ...
        yml.addDefault(Messages.COMMAND_JOIN_USAGE, "§a▪ §7用法： /" + BedWars.mainCmd + " join §o<游戏/模式组>");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_DENIED_PARTY_TOO_BIG, "{prefix}&c你的队伍人数太多了，不能作为一个队伍加入这个游戏：(");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG, "&c这个游戏不允许旁观！");
        yml.addDefault(Messages.COMMAND_TP_PLAYER_NOT_FOUND, "{prefix}&c无法找到这位玩家！");
        yml.addDefault(Messages.COMMAND_TP_NOT_IN_ARENA, "{prefix}&c这个玩家不在一个起床战争的游戏中！");
        yml.addDefault(Messages.COMMAND_TP_NOT_STARTED, "{prefix}&c这个玩家所在的游戏还没有开始游戏！");
        ...
        yml.addDefault(Messages.COMMAND_LEAVE_DENIED_NOT_IN_ARENA, "{prefix}&c你不在一个游戏中！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_HELP, Arrays.asList("&6▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬", "&a队伍指令：", "&e/party help &7- &b查看这个提示", "&e/party invite <玩家> &7- &b邀请一位玩家到你的队伍", "&e/party leave &7- &b离开当前队伍", "&e/party remove <玩家> &7- &b将玩家移出队伍", "&e/party accept <玩家> &7- &b接受队伍邀请", "&e/party disband &7- &bD解散队伍"));
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_PLAYER_TUTORIAL, Arrays.asList(
                ...
                "",
                "&a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        yml.addDefault(Messages.ARENA_JOIN_DENIED_SELECTOR, "{prefix}&c抱歉，你现在不能加入这个游戏. 右键来观赛！");
        ...
        yml.addDefault(Messages.INTERACT_BED_DESTROY_CHAT_ANNOUNCEMENT_TO_VICTIM, "&f&l床被破坏 > &7你的床 被{PlayerColor}{PlayerName}&7破坏了！");
        yml.addDefault(Messages.INTERACT_CHEST_CANT_OPEN_TEAM_ELIMINATED, "&c由于此队伍还未被团灭，你不能打开这个团队箱子！");
        ...
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_REGULAR, "{PlayerColor}{PlayerName}&7在与{KillerColor}{KillerName}&7 战斗时断开连接。");
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_FINAL, "{PlayerColor}{PlayerName}&7在与{KillerColor}{KillerName}&7 战斗时断开连接。 &b&l最终击杀！");
        ...
        yml.addDefault(Messages.PLAYER_DIE_PVP_REGULAR_KILL, "{PlayerColor}{PlayerName}&7被{KillerColor}{KillerName}&7 击杀。");
        yml.addDefault(Messages.PLAYER_DIE_PVP_FINAL_KILL, "{PlayerColor}{PlayerName}&7被{KillerColor}{KillerName}&7 击杀。 &b&l最终击杀！");
        ...
        yml.addDefault(Messages.SHOP_INSUFFICIENT_MONEY, "{prefix}&c你没有足够的{currency}！ 还需要{amount}个！");
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "first", Arrays.asList("&7第一个进入你基地的敌人将触发这个陷阱！"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "second", Arrays.asList("&7第二个进入你基地的敌人将触发这个陷阱！"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "third", Arrays.asList("&7第三个进入你基地的敌人将触发这个陷阱！"));
