...
public class ChineseSimplified extends Language {
    public ChineseSimplified() {
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "armor").replace("{tier}", "tier-1"), Arrays.asList("&7队伍的所有护甲获得保护附魔！", "", "{tierColor}等级 1： 保护I &b{cost} {currency}", "&7等级 2： 保护II, &b10 钻石", "&7等级 3： 保护III, &b20 钻石", "&7等级 4： 保护IV, &b30 钻石", ""));
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "armor").replace("{tier}", "tier-2"), "{color}护甲强化II");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "armor").replace("{tier}", "tier-2"), Arrays.asList("&7队伍的所有护甲获得保护附魔！", "", "&a等级 1： 保护I &b5 钻石", "{tierColor}等级 2： 保护II, &b{cost} {currency}", "&7等级 3： 保护III, &b20 钻石", "&7等级 4： 保护IV, &b30 钻石", ""));
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "armor").replace("{tier}", "tier-3"), "{color}护甲强化III");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "armor").replace("{tier}", "tier-3"), Arrays.asList("&7队伍的所有护甲获得保护附魔！", "", "&a等级 1： 保护I &b5 钻石", "&a等级 2： 保护II, &b10 钻石", "{tierColor}等级 3： 保护III, &b{cost} {currency}", "&7等级 4： 保护IV, &b30 钻石", ""));
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "armor").replace("{tier}", "tier-4"), "{color}护甲强化IV");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "armor").replace("{tier}", "tier-4"), Arrays.asList("&7队伍的所有护甲获得保护附魔！", "", "&a等级 1： 保护I &b5 钻石", "&a等级 2： 保护II, &b10 钻石", "&a等级 3： 保护III, &b20 钻石", "{tierColor}等级 4： 保护IV, &b{cost} {currency}", ""));
